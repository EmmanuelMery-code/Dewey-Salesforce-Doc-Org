...
def show_history_screen(app: Application) -> None:
        ...
        try:
            with open(file_path, "w", newline="", encoding="utf-8-sig") as f:
                ...
                writer.writerow([
                    ...
                    app._t("adopt_adapt_overall_score"), "Couverture Org", "Couverture Apex", "Couverture Flows",
                ...
                for e in entries:
                    writer.writerow([
                        ...
                        f"{e.test_coverage:.1f}%" if e.test_coverage is not None else "N/A",
    ...
    columns = (
        "num", "timestamp", "score", "adopt_adapt", "coverage", "coverage_apex", "coverage_flows", "objects", "fields", 
