...
> **Companion document** — [`ANALYSIS_RULES.md`](ANALYSIS_RULES.md) explains how individual rules detect what they detect.
...
![Mode A pipeline](diagrams/02-mode-a-pipeline.png)
...
![Mode B pipeline](diagrams/03-mode-b-pipeline.png)
...
This document embeds the PNG, so it displays in any Markdown viewer without a draw.io plugin. A parallel copy, [`ARCHITECTURE.svg.md`](ARCHITECTURE.svg.md), embeds the SVG instead — identical prose, sharper at any zoom, and about fifteen times lighter. Use whichever your reader handles better; SVG is preferable on GitHub and in the browser, PNG in Word or e-mail.
