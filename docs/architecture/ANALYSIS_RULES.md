...
> **Companion document** — [`ARCHITECTURE.md`](ARCHITECTURE.md) covers the surrounding application.
...
![Rule evaluation pipeline](diagrams/04-rule-evaluation-pipeline.png)
...
![Apex self-recursion detection](diagrams/05-apex-self-recursion.png)
...
![Apex call cycle detection](diagrams/06-apex-call-cycle-tarjan.png)
